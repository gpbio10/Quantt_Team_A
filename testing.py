...
#####--------------------------------------------
        ...
        class Algorithm(QCAlgorithm):
            def Initialize(self):
                ...
                self.Schedule.On(self.DateRules.EveryDay("DAL"), self.TimeRules.AfterMarketOpen("DAL", 30),
                                 self.GetSource)
                self.Schedule.On(self.DateRules.EveryDay("DAL"), self.TimeRules.AfterMarketOpen("DAL", 2),
                                 self.checkIfBought)
                    ...
                    if (stock != "BLNK"):
                        ...
                        if (p > 0.05):
                            ...
                            if (p > 0.05):
                                ...
                                # second_diff.drop(index=second_diff.index[0], axis=0, inplace=True)
                                d = 2
